...
VALUES ('neurčený',CURRENT_TIMESTAMP),
	   ...
	   ('dirigent',CURRENT_TIMESTAMP),
	   ('estetik',CURRENT_TIMESTAMP),
	   ('muzikológ',CURRENT_TIMESTAMP),
	   ('teoretik',CURRENT_TIMESTAMP),
	   ('pedagóg',CURRENT_TIMESTAMP),
	   ('klavirista',CURRENT_TIMESTAMP);